 ...
 */
@interface IRModelProtoTransaction : NSObject {
@private
    struct ModelProtoTransactionImpl* modelProtoTransactionImpl;
}
 ...
 * object
 * @param unsignedTransactionObjC - unsigned transaction
