...
public class IrohaTransactionBuilder {
    ...
    public func transactionCounter(_ transactionCounter: Int32) -> IrohaTransactionBuilder {
        modelTransactionBuilder = modelTransactionBuilder.transactionCounter(transactionCounter)
        return self
    }
