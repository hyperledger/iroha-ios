...
public class IrohaQueryBuilder {
    ...
    public func getAccountAssets(forAccountId accountId: String,
                                 withAssetId assetId: String) -> IrohaQueryBuilder {
        modelQueryBuilder = modelQueryBuilder.getAccountAssets(withAccountId: accountId, withAssetId: assetId);
        return self
    }
