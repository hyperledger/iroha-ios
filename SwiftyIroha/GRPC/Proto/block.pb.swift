...
public struct Iroha_Protocol_Header: SwiftProtobuf.Message {
  public static let protoMessageName: String = _protobuf_package + ".Header"

  public var createdTime: UInt64 = 0

  public var signatures: [Iroha_Protocol_Signature] = []
...
public struct Iroha_Protocol_Transaction: SwiftProtobuf.Message {
  public static let protoMessageName: String = _protobuf_package + ".Transaction"

  public var payload: Iroha_Protocol_Transaction.Payload {
  ...
  public struct Payload: SwiftProtobuf.Message {
    public static let protoMessageName: String = Iroha_Protocol_Transaction.protoMessageName + ".Payload"

    public var commands: [Iroha_Protocol_Command] = []

    public var creatorAccountID: String = String()

    public var txCounter: UInt64 = 0
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try decoder.decodeSingularUInt64Field(value: &self.txCounter)
        case 4: try decoder.decodeSingularUInt64Field(value: &self.createdTime)
        default: break
        }
      }
    }
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
      ...
      if self.txCounter != 0 {
        try visitor.visitSingularUInt64Field(value: self.txCounter, fieldNumber: 3)
      }
      if self.createdTime != 0 {
        try visitor.visitSingularUInt64Field(value: self.createdTime, fieldNumber: 4)
      }
      try unknownFields.traverse(visitor: &visitor)
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try decoder.decodeRepeatedMessageField(value: &_storage._signature)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._signature.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._signature, fieldNumber: 2)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
public struct Iroha_Protocol_Block: SwiftProtobuf.Message {
  public static let protoMessageName: String = _protobuf_package + ".Block"

  public var payload: Iroha_Protocol_Block.Payload {
  ...
  public struct Payload: SwiftProtobuf.Message {
    public static let protoMessageName: String = Iroha_Protocol_Block.protoMessageName + ".Payload"

    public var transactions: [Iroha_Protocol_Transaction] = []

    /// the number of transactions inside. Maximum 16384 or 2^14
    public var txNumber: UInt32 = 0

    /// the current block number in a ledger
    public var height: UInt64 = 0

    /// Previous block hash
    public var prevBlockHash: Data = SwiftProtobuf.Internal.emptyData
...
extension Iroha_Protocol_Header: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "created_time"),
    2: .same(proto: "signatures"),
  ]

  public func _protobuf_generated_isEqualTo(other: Iroha_Protocol_Header) -> Bool {
...
extension Iroha_Protocol_Transaction: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  fileprivate class _StorageClass {
    ...
    var _signature: [Iroha_Protocol_Signature] = []
  ...
  public func _protobuf_generated_isEqualTo(other: Iroha_Protocol_Transaction) -> Bool {
...
extension Iroha_Protocol_Transaction.Payload: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "commands"),
    2: .standard(proto: "creator_account_id"),
    3: .standard(proto: "tx_counter"),
    4: .standard(proto: "created_time"),
  ]

  public func _protobuf_generated_isEqualTo(other: Iroha_Protocol_Transaction.Payload) -> Bool {
    if self.commands != other.commands {return false}
    if self.creatorAccountID != other.creatorAccountID {return false}
    if self.txCounter != other.txCounter {return false}
    if self.createdTime != other.createdTime {return false}
    if unknownFields != other.unknownFields {return false}
    return true
  }
...
extension Iroha_Protocol_Block: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "payload"),
    2: .same(proto: "signatures"),
  ]
  ...
  public func _protobuf_generated_isEqualTo(other: Iroha_Protocol_Block) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
...
extension Iroha_Protocol_Block.Payload: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public func _protobuf_generated_isEqualTo(other: Iroha_Protocol_Block.Payload) -> Bool {
