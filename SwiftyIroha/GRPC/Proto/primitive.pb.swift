...
public enum Iroha_Protocol_RolePermission: SwiftProtobuf.Enum {
...
public enum Iroha_Protocol_GrantablePermission: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
public struct Iroha_Protocol_Signature: SwiftProtobuf.Message {
...
public struct Iroha_Protocol_uint256: SwiftProtobuf.Message {
  public static let protoMessageName: String = _protobuf_package + ".uint256"

  public var first: UInt64 = 0

  public var second: UInt64 = 0

  public var third: UInt64 = 0

  public var fourth: UInt64 = 0
...
public struct Iroha_Protocol_Amount: SwiftProtobuf.Message {
  public static let protoMessageName: String = _protobuf_package + ".Amount"

  public var value: Iroha_Protocol_uint256 {
...
public struct Iroha_Protocol_Peer: SwiftProtobuf.Message {
  public static let protoMessageName: String = _protobuf_package + ".Peer"

  public var address: String = String()

  public var peerKey: Data = SwiftProtobuf.Internal.emptyData
...
extension Iroha_Protocol_Signature: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func _protobuf_generated_isEqualTo(other: Iroha_Protocol_Signature) -> Bool {
...
extension Iroha_Protocol_uint256: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func _protobuf_generated_isEqualTo(other: Iroha_Protocol_uint256) -> Bool {
...
extension Iroha_Protocol_Amount: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func _protobuf_generated_isEqualTo(other: Iroha_Protocol_Amount) -> Bool {
...
extension Iroha_Protocol_Peer: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func _protobuf_generated_isEqualTo(other: Iroha_Protocol_Peer) -> Bool {
