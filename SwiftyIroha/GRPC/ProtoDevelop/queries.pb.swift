...
struct Iroha_Protocol_QueryPayloadMeta: SwiftProtobuf.Message {
...
struct Iroha_Protocol_BlocksQuery: SwiftProtobuf.Message {
...
extension Iroha_Protocol_QueryPayloadMeta: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Iroha_Protocol_BlocksQuery: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "meta"),
    2: .same(proto: "signature"),
  ]
