...
struct Iroha_Protocol_Proposal: SwiftProtobuf.Message {
...
extension Iroha_Protocol_Proposal: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
