...
extension IrohaDataModelQuery {
    public indirect enum VersionedQueryResult: Swift.Codable {
        case v1(IrohaDataModelQuery._VersionedQueryResultV1)
        ...
        public init(from decoder: Swift.Decoder) throws {
            ...
            switch discriminant {
            case 1:
                let val0 = try container.decode(IrohaDataModelQuery._VersionedQueryResultV1.self)
                self = .v1(val0)
                break
            default:
        ...
        public func encode(to encoder: Swift.Encoder) throws {
            ...
            try container.encode(VersionedQueryResult.discriminant(of: self))
            switch self {
            case let .v1(val0):
