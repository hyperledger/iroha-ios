...
public init(signing data: Data, with keyPair: IrohaKeyPair) throws {
    ...
    */
    ...
    do {
        ...
        let test = [-14, 52, -123, 100, 16, -109, -123, 94, 92, -11, 121, 53, 75, -125, -26, 113, -51, 102, 126, -83, 102, 15, -56, 21, 41, -115, 95, 42, -74, -84, -60, 37].count

        //hash = Data(SHA512.hash(data: hash))

        //debugPrint("SHA512: \(Array(hash).toSigned())")

        let valid: [Int8] = [3, -105, 122, -80, 84, 70, 2, 126, -83, 19, -96, -83, 43, -10, 72, 83, -28, 26, 73, 53, -10, -44, -8, 94, -124, -119, 43, 29, -56, -29, -91, -118, 20, -26, 39, 47, 111, -38, 28, 110, -73, -8, 98, 79, 97, -38, -12, -16, -66, 5, 76, 47, -97, -92, 117, 34, 13, 83, -120, -22, -126, -41, 51, 14]

        let validData = Data.init(bytes: valid, count: valid.count)
        ...
        debugPrint(privateKey.publicKey.isValidSignature(validData, for: Data(hash)))
    } catch let error {
