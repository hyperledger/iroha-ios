...
class Transaction_Payload : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:iroha.protocol.Transaction.Payload) */ {
 public:
  ...
  // uint64 tx_counter = 3;
  void clear_tx_counter();
  static const int kTxCounterFieldNumber = 3;
  ::google::protobuf::uint64 tx_counter() const;
  void set_tx_counter(::google::protobuf::uint64 value);
 ...
 private:
  ...
  ::google::protobuf::uint64 tx_counter_;
  ::google::protobuf::uint64 created_time_;
  mutable int _cached_size_;
  friend struct protobuf_block_2eproto::TableStruct;
};
...
class Transaction : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:iroha.protocol.Transaction) */ {
 public:
  ...
  const ::iroha::protocol::Signature& signature(int index) const;
  ::iroha::protocol::Signature* mutable_signature(int index);
  ::iroha::protocol::Signature* add_signature();
  ::google::protobuf::RepeatedPtrField< ::iroha::protocol::Signature >*
      mutable_signature();
  const ::google::protobuf::RepeatedPtrField< ::iroha::protocol::Signature >&
      signature() const;
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::iroha::protocol::Signature > signature_;
...
inline void Header::clear_signatures() {
  signatures_.Clear();
}
...
inline void Transaction_Payload::clear_commands() {
  commands_.Clear();
}
...
// uint64 tx_counter = 3;
inline void Transaction_Payload::clear_tx_counter() {
  tx_counter_ = GOOGLE_ULONGLONG(0);
}
inline ::google::protobuf::uint64 Transaction_Payload::tx_counter() const {
  // @@protoc_insertion_point(field_get:iroha.protocol.Transaction.Payload.tx_counter)
  return tx_counter_;
}
inline void Transaction_Payload::set_tx_counter(::google::protobuf::uint64 value) {
  
  tx_counter_ = value;
  // @@protoc_insertion_point(field_set:iroha.protocol.Transaction.Payload.tx_counter)
}
...
inline const ::iroha::protocol::Signature& Transaction::signature(int index) const {
  // @@protoc_insertion_point(field_get:iroha.protocol.Transaction.signature)
  return signature_.Get(index);
}
inline ::iroha::protocol::Signature* Transaction::mutable_signature(int index) {
  // @@protoc_insertion_point(field_mutable:iroha.protocol.Transaction.signature)
  return signature_.Mutable(index);
}
inline ::iroha::protocol::Signature* Transaction::add_signature() {
  // @@protoc_insertion_point(field_add:iroha.protocol.Transaction.signature)
  return signature_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::iroha::protocol::Signature >*
Transaction::mutable_signature() {
  // @@protoc_insertion_point(field_mutable_list:iroha.protocol.Transaction.signature)
  return &signature_;
}
inline const ::google::protobuf::RepeatedPtrField< ::iroha::protocol::Signature >&
Transaction::signature() const {
  // @@protoc_insertion_point(field_list:iroha.protocol.Transaction.signature)
  return signature_;
}
